...
const Register=()=>{
    ...
    return (
        <form className="px-16 flex flex-col gap-5" onSubmit={onSubmit}>
            ...
            <label className="text-gray-700 text-sm font-bold flex-1">
                ...
                <span> 
                    <button type="submit" className="bg-blue-600 text-white p-2 font-bold hover:bg-blue-500 text-xl rounded">Create Account</button>
                </span>
